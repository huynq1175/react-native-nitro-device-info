...
import { PlatformAvailability, PropertyCategory, PropertyType } from '../types';
...
export function isPlatformSupported(
  property: Pick<DeviceProperty, 'platform'>
): boolean {
  if (property.platform === PlatformAvailability.ALL) return true;
  if (property.platform === PlatformAvailability.IOS_ONLY)
    return Platform.OS === 'ios';
  if (property.platform === PlatformAvailability.ANDROID_ONLY)
 ...
 */
export function getPropertiesForCategory(
  category: PropertyCategory
): Omit<DeviceProperty, 'value' | 'errorState'>[] {
